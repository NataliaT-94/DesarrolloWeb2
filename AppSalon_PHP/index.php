<?php 
    ...
    //echo __DIR__;//imprime el directorio que esta ejecutando ese DIR
    //echo __FILE__;//imprime el archivo que esta ejecutando ese FILE
        ...
        <div class="app">
            ...
            <div class="seccion">
                ...
                <div id="servicios" class="listado-servicios">
                    ...
                    ?>
                    <div class="servicio">
                        <p class="nombre-servicio"><?php echo $servicio['nomnbre']; ?></p>
