<fieldset class="formulario__fieldset">
    ...
    <?php if(isset($ponente->imagen_actual)) {?>
        ...
        <div class="formulario__imagen">
            <picture>
                <source srcset="<?php echo $_ENV['HOST'] . '/img/speakers/' . $ponente->imagen; ?>.webp" alt="Imagen Ponente" type="image/webp">
                <source srcset="<?php echo $_ENV['HOST'] . '/img/speakers/' . $ponente->imagen; ?>.png" alt="Imagen Ponente" type="image/png">
...
<fieldset class="formulario__fieldset">
    <legend class="formulario__legend">IRedes Sociales</legend>
