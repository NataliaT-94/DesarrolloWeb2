...
<section class="resumen">
    <div class="resumen__grid">
        ...
        <div <?php aos_animacion(); ?> class="resumen__bloque">
            ...
            <p class="resumen__texto">Asisitentes</p>
        </div>
    </div>
</section>
    ...
    <div class="speakers__grid">
        <?php foreach($ponentes as $ponente){ ?>
            <div <?php aos_animacion(); ?> class="speaker">
                <picture>
                    <source srcset=" img/speakers/<?php echo $ponente->imagen; ?>.webp" alt="Imagen Ponente" type="image/webp">
                    <source srcset=" img/speakers/<?php echo $ponente->imagen; ?>.png" alt="Imagen Ponente" type="image/png">
                ...
                <div class="speaker__informacion">
                    ...
                    <nav class="speaker-sociales">
                        ...
                        <?php if(!empty($redes->tiktok)){ ?>
                            <a class="speaker-sociales__enlace" rel="noopener noreferrer" target="_blank" href="h<?php echo $redes->tiktok; ?>">
                    ...
                    <ul class="speaker__listado-skills">
                        <?php
                            $tags = explode(',', $ponente->tags); //separa por las comas los ponentes y los trae como array
                            foreach($tags as $tag){ ?>
