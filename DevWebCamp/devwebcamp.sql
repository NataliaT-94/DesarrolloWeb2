...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-10-2025 a las 21:47:38
...
(10, ' Natalia', 'Techeira', 'correo@correo.com', '$2y$10$0mg2aQAHfKDfDugwHtlyueIDgKZ/N6RP6OnJnkWxbwR8SHK9U6XPa', 1, '', 0),
(11, ' Braian Hernan', 'Zamudio', 'admin@admin.com', '$2y$10$upTa5XveJMuK5cGXa57vW.ecC859I0J.fceU7ZIdRQwnghloN5qke', 1, '', 1),
(12, ' Natt', 'Techeira', 'correo2@correo.com', '$2y$10$wuRNgM4lidwswbz8JdhioOzAh19LdHvihcsvNbnK0NuL4FmqrikU2', 1, '', 0),
(13, ' eve', 'techeira', 'correo3@correo.com', '$2y$10$fG5eBSh/8ONX6EzrfC1bvOLMeT3Vqp1IbiRkqfH52E5eP6G2D.dSu', 1, '', 0);
...
--
ALTER TABLE `registros`
  ADD CONSTRAINT `fk_regalos` FOREIGN KEY (`regalo_id`) REFERENCES `regalos` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
