...
<div class="eventos-registros">
    <main class="eventos-registros__listado">
        <h3 class="eventos-registros__heading--conferencias">&lt;Confrencias /></h3>
        <p class="eventos-registros__fecha">Viernes 14 de Marzo</p>
        ...
        <p class="eventos-registros__fecha">Sabado 15 de Marzo</p>
